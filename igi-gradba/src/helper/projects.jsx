...
export const projects = [
   ...
   {
        id: 10,
        slug: "potporen-zid-sopiste",
        title: "Изработка на потпорен ѕид во населба Сопиште",
        category: "exterior",
        categoryLabel: "Надворешно уредување",
        featured: false,
        beforeImg: project3Images.before,
        ...
        description:
            "Проектот опфати подготовка и уредување на теренот за изработка на потпорен ѕид како дел од надворешно игралиште во населба Сопиште. По извршувањето на потребниот ископ, следуваше поставување на оплата, армирање и бетонирање на потпорниот ѕид. По завршувањето на градежните работи, просторот беше целосно расчистен, а отпадниот материјал беше собран и отстранет на соодветна локација.",
        location: "Сопиште, Скопје",
        year: "2026",
        ...
        workPerformed: [
            ...
            "Армирање на потпорниот ѕид",
            "Бетонирање на потпорниот ѕид",
            "Расчистување на просторот по завршување на работите",
            "Собирање и отстранување на отпадниот материјал",
        ],
    },   
];